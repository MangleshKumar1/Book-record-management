...
model and controller are w.r.t. backend
model/modal :- all backend- nodejs,expressjs,mongoose, mongodb
view:- frontend part - reactjs, vuejs, or angularjs
controller:- also backend- called Brain OR Logic of route

-->

<!-- modal also speaks about the structure of mongodb collection -->